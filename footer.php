...
<div class="container-fluid footer">
				...
				<ul class="news-list">
					<?php while ($teknologi_list = $list_teknologi->fetch_array()) { ?>
						<li>
							...
							<p>Oleh: <a href="<?php echo $base_url . "author.php?id=" . $teknologi_list['id_admin']; ?>"><?php echo $teknologi_list['nama_lengkap']; ?></a>&nbsp;&nbsp;&ndash;&nbsp;&nbsp;<?php echo $teknologi_list['tgl_posting']; ?>
							</p>
							<a href="<?php echo $base_url . "detail.php?id=" . $teknologi_list['id_berita'] . "&amp;judul=" . strtolower(str_replace(" ", "-", $teknologi_list['judul'])); ?>">
				...
				<ul class="news-list">
					<?php while ($nasional_list = $list_nasional->fetch_array()) { ?>
						<li>
							...
							<p>Oleh: <a href="<?php echo $base_url . "author.php?id=" . $nasional_list['id_admin']; ?>"><?php echo $nasional_list['nama_lengkap']; ?></a>&nbsp;&nbsp;&ndash;&nbsp;&nbsp;<?php echo $nasional_list['tgl_posting']; ?>
							</p>
							<a href="<?php echo $base_url . "detail.php?id=" . $nasional_list['id_berita'] . "&amp;judul=" . strtolower(str_replace(" ", "-", $nasional_list['judul'])); ?>">
				...
				<ul class="news-list">
					<?php while ($olahraga_list = $list_olahraga->fetch_array()) { ?>
						<li>
							...
							<p>Oleh: <a href="<?php echo $base_url . "author.php?id=" . $olahraga_list['id_admin']; ?>"><?php echo $olahraga_list['nama_lengkap']; ?></a>&nbsp;&nbsp;&ndash;&nbsp;&nbsp;<?php echo $olahraga_list['tgl_posting']; ?>
							</p>
							<a href="<?php echo $base_url . "detail.php?id=" . $olahraga_list['id_berita'] . "&amp;judul=" . strtolower(str_replace(" ", "-", $olahraga_list['judul'])); ?>">
	...
	<div class="row footer-bottom">
		<div class="col-md-12">
			<span class="copy">Copyright &copy; <?php echo date('Y'); ?> Berita Kita | Powered by Group 3 Class B
			</span>
		</div>
	</div>
</div>
