                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');"
                                                href="aksi-kat.php?act=hapus&amp;id=<?=$kat_list['id_kategori']?>"
                                                class="btn btn-sm btn-danger">
                                                <i class="fa fa-trash"></i>
                                            </a>
                                            <a onclick="return confirm('Anda Yakin Ingin Mengupdate Data Ini?');"
                                                href="edit-kat.php?id=<?=$kat_list['id_kategori']?>"
